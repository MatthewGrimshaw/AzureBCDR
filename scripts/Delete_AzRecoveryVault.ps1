...
$VaultName = "AzRecoveryVault" #fetch automatically
$Subscription = "ME-MngEnv077352-matgri-1" #fetch automatically
$ResourceGroup = "AzureBCDR" #fetch automatically
$SubscriptionId = "6a509a0a-f0b6-4e8c-88d3-7108d0f37309" #fetch automatically
